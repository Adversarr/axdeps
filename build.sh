...
export PKG_CONFIG_PATH=$INSTALL_PREFIX_WITHOUT_LIBNAME/lib/pkgconfig:$PKG_CONFIG_PATH
...
$AX_CMAKE \
  ...
  -B "$BUILD_DIR/spdlog" \
  -DCMAKE_MODULE_PATH="$INSTALL_PREFIX_WITHOUT_LIBNAME" \
  -DCMAKE_BUILD_TYPE=$BUILD_TYPE \
  -DCMAKE_INSTALL_PREFIX=$INSTALL_PREFIX_WITHOUT_LIBNAME \
  -DBUILD_SHARED_LIBS=OFF \
